...
########################################################## FIRE PIT ###########################################################################################################
FirePit = [pygame.image.load("Sprites/Fire/Fire/fire1.jpg"), pygame.image.load("Sprites/Fire/Fire/fire2.jpg"),\
             pygame.image.load("Sprites/Fire/Fire/fire3.jpg"), pygame.image.load("Sprites/Fire/Fire/fire4.jpg"),\
             pygame.image.load("Sprites/Fire/Fire/fire5.jpg"), pygame.image.load("Sprites/Fire/Fire/fire6.jpg")]
############################################################################################################################################################
characterDictionary["Fire Pit"] = (FirePit)
############################################################################################################################################################
