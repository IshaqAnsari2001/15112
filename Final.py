...
firepit = pygame.image.load('Fire1.jpg').convert()
firepit.set_colorkey((0,0,0))

    
class MC():
    
    walkRight = characters["Lightning Wizard"][0]
    walkLeft = characters["Lightning Wizard"][1]
    idle = characters["Lightning Wizard"][2]
...
class projectile(MC):
    ...
    ballLeft = characters["Lightning Ball"][1]
    ballRight = characters["Lightning Ball"][0]
...
def redrawGameWindow(win):
    win.blit(pygame.image.load('Fire1.jpg').convert(),(0,700))
    win.blit(pygame.image.load('Fire1.jpg').convert(),(320,700))
    win.blit(pygame.image.load('Fire1.jpg').convert(),(320 * 2,700))
    win.blit(pygame.image.load('Fire1.jpg').convert(),(320 * 3,700))
    win.blit(pygame.image.load('Fire1.jpg').convert(),(320 * 4,700))
...
while Program:
    ...
    if enemy.visible:
        if Hero.x + Hero.width >= enemy.x and Hero.x + Hero.width <= enemy.x + enemy.width:
            if (Hero.y + 5 >= enemy.y) and condition:
                Hero.hit()
                condition = False
    ...
    if enemy1.visible:
        if Hero.x + Hero.width >= enemy1.x and Hero.x + Hero.width <= enemy1.x + enemy1.width:
            if (Hero.y + 10 >= enemy1.y) and condition1:
                Hero.hit()
                condition1 = False
